        ...
        {skills?.map((skill, index) => (
          <div key={index} className="mb-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="font-bold text-Black text-sm">{animatedProgress[index]}%</span>
            </div>
            <div className="relative w-full h-1 bg-Black rounded-full overflow-hidden">
              <div className="absolute top-0 left-0 h-full bg-WhiteGray rounded-full" style={{width: `${visible ? animatedProgress[index] : 0}%`, transition: "width 1s"}}>
